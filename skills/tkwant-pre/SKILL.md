---
name: tkwant-pre
description: This skill should be used when users ask about pre in tkwant; it prioritizes documentation references and then source inspection only for unresolved details.
---

# tkwant: Pre

## Scope
- Handle questions about documentation grouped under the 'pre' theme.
