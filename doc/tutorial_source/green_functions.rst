...
.. math::
   ...
   \begin{align}
     ...
     I_{ij}(t) &= 2  \Im \int \frac{d E}{2 \pi} \sum_{\alpha} f_\alpha(E) \psi_{\alpha E}^*(t, i)  H_{ij}(t)   \psi_{\alpha E}(t, j) . 
   \end{align}
...
.. jupyter-execute::
    ...
    plt.plot(times, g_less_00.real, 'o-', color='#e15759', label=r'$\Re G^<_{00}$')
    plt.plot(times, g_less_00.imag, 'o-',color='#f28e2b', label=r'$\Im G^<_{00}$')
    
    plt.plot(times, g_less_10.real, 'o-', color='#4e79a7', label=r'$\Re G^<_{10}$')
    plt.plot(times, g_less_10.imag, 'o-', color='#76b7b2', label=r'$\Im G^<_{10}$')
...
.. jupyter-execute::
    ...
    plt.suptitle(r'$\gamma_L={}, \gamma_C={}, \gamma_R={}, \epsilon_R={}, \mu_L={}, \mu_R={}$'.
...
.. jupyter-execute::
    ...
    green_types['anti_ordered'] = r'G^{\overline{T}}'
...
.. jupyter-execute::
    ...
    for i, (key, gtype) in enumerate(green_types.items()):
        ...
        axes[i][0].set_title(r'$\Re ' + gtype + '_{00}(t)$')
        ...
        axes[i][1].set_title(r'$\Im ' + gtype + '_{00}(t)$')
        ...
        axes[i][2].set_title(r'$\Re ' + gtype + '_{01}(t)$')
        ...
        axes[i][3].set_title(r'$\Im ' + gtype + '_{01}(t)$')
    
    for axx in axes:
        for ax in axx:
            ax.set_xlim(-max(times), max(times))
    
    plt.suptitle(r'$\gamma_L={}, \gamma_C={}, \gamma_R={}, \epsilon_L={}, \epsilon_R={}, \mu_L={}, \mu_R={}$'.
                 format(gamma_L, gamma_C, gamma_R, epsilon_L, epsilon_R, mu_L, mu_R), size=22)
